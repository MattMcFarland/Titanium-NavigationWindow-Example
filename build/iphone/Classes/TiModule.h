...
/**
 The base class for all IOS_NAV modules
 */
...
/**
 IOS_NAV Platform calls this method on startup.
 */
-(void)startup;

/**
 IOS_NAV Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 IOS_NAV Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 IOS_NAV Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 IOS_NAV Platform calls this method on resume.
 @param sender The sender of the event.
 */

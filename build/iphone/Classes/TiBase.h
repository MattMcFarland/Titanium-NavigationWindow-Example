...
// in simulator we redefine to format for IOS_NAV Developer console
...
{\
	NSString * exceptionName = [@"org.ios_nav." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ios_nav";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIOS_NAVNativeItemNone = -1, 
	UIIOS_NAVNativeItemSpinner = -2,
	UIIOS_NAVNativeItemProgressBar = -3,
	
	UIIOS_NAVNativeItemSlider = -4,
	UIIOS_NAVNativeItemSwitch = -5,
	UIIOS_NAVNativeItemMultiButton = -6,
	UIIOS_NAVNativeItemSegmented = -7,
	
	UIIOS_NAVNativeItemTextView = -8,
	UIIOS_NAVNativeItemTextField = -9,
	UIIOS_NAVNativeItemSearchBar = -10,
	
	UIIOS_NAVNativeItemPicker = -11,
	UIIOS_NAVNativeItemDatePicker = -12,
	
	UIIOS_NAVNativeItemInfoLight = -13,
	UIIOS_NAVNativeItemInfoDark = -14,
	
	UIIOS_NAVNativeItemDisclosure = -15,
	
	UIIOS_NAVNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all IOS_NAV instances of

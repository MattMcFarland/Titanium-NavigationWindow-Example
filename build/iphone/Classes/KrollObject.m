...
//@interface IOS_NAVObject : NSObject
//@end

@interface IOS_NAVObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[IOS_NAVObject class]])
		{
			for (NSString *key in [[(IOS_NAVObject*)o modules] allKeys])
			{
